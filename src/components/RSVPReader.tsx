  ...
  return (
    <section className={styles.screen}>
      ...
      <div className={styles.rsvpContainer}>
        ...
        <div className={styles.meta} aria-label="Okuma bilgileri">
          <span>{localWpm} KDK</span>
          <span className={styles.metaDivider} aria-hidden="true">·</span>
          <span>{Math.round(progress)}%</span>
          <span className={styles.metaDivider} aria-hidden="true">·</span>
          <span className={styles.metaEta} aria-label={`Kalan süre: ${etaLabel}`}>
      ...
      {/* Controls */}
      <div className={styles.controls} aria-label="Okuma kontrolleri">
        <button className={styles.ctrlBtn} onClick={restart} aria-label="Metnin başına dön" title="Başa dön">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true">
            <polyline points="1 4 1 10 7 10" />
            <path d="M3.51 15a9 9 0 1 0 .49-4.95" />
          </svg>
        </button>
        <button className={styles.ctrlBtn} onClick={goBack} aria-label="10 kelime geri git" title="Geri (←)">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true">
        ...
        <button className={styles.ctrlBtn} onClick={goForward} aria-label="10 kelime ileri git" title="İleri (→)">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true">
            <polyline points="9 18 15 12 9 6" />
          </svg>
        </button>
        <button className={styles.ctrlBtn} onClick={onClose} aria-label="Okuyucuyu kapat" title="Çıkış">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true">
      ...
      <div className={styles.speedRow}>
        <div className={styles.speedLabelRow}>
          ...
          <span className={styles.speedValue} aria-live="polite">{localWpm} KDK</span>
        </div>
        <input
          type="range"
          min={60}
          ...
          aria-label="Okuma hızı slider (Kelime Başına Dakika)"
        />
