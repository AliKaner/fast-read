...
export default function FullTextPanel({
  ...
  return (
    <div className={`${styles.panel} ${open ? styles.panelOpen : styles.panelClosed}`} role="complementary" aria-label="Tam metin görünümü">
      <button
        className={styles.header}
        onClick={() => setOpen((v) => !v)}
        aria-expanded={open}
        aria-controls="full-text-body"
        aria-label={open ? "Tam metin panelini daralt" : "Tam metin panelini genişlet"}
      >
      ...
      <div id="full-text-body" className={styles.bodyWrapper}>
